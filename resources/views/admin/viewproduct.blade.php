                                ...
                                <h3 class="card-title">Product Detail</h3>
                                 ...
                                 <div class="card-body">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-key-events="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-click-to-select="true" data-toolbar="#toolbar" >
                                            ...
                                            <tr>
                                                <td>&nbsp;{{$d->id}}</td>
                                                <td><strong>&nbsp;&nbsp;<a href='productdetail/{{ $d->id }}'>{{$d->name}}</a></strong></td>
                                                <td>&nbsp;{{$d->des}}</td>
                                                <td>&nbsp;{{$d->cname}}</td>
                                                ...
                                                <td>&nbsp;
                                                    @if($d->status == 'active')
                                                    <a href="{{route('product_active',['id'=>encrypt($d->id),'status'=>'active'])}}">Active</a>  
                                                    @else
                                            <a href="{{route('product_active',['id'=>encrypt($d->id),'status'=>'inactive'])}}">InActive</a>  
                                                    @endif
                                                </td>


                                                <td>&nbsp;&nbsp;&nbsp;<img src="{{url('storage/app/product')}}{{'/'}}{{$d->image}}" style="height:130px;width: 140px;" ></td>
                                                
                                                <td>&nbsp;&nbsp;<a href="deleteproduct/{{ $d->id }}" class="btn btn-danger btn-md"><span class="glyphicon glyphicon-trash"></span> Delete </a></td>

                                                <td>&nbsp;&nbsp;<a href="#" class="btn btn-info btn-mg">    <span class="glyphicon glyphicon-pencil"></span> Edit</a></td>
