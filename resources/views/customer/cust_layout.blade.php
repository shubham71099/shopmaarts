            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('web_customer_login') }}">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('web_customer_register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('web_customer_register') }}">{{ __('Register') }}</a>
                                </li>    
                            @endif
                        @endif
